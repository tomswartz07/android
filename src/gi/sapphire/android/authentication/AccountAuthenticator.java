...
public class AccountAuthenticator extends AbstractAccountAuthenticator {
     ...
     */
    public static final String ACCOUNT_TYPE = "sapphire";
    public static final String AUTHORITY = "gi.sapphire";
    public static final String AUTH_TOKEN_TYPE = "gi.sapphire";
    public static final String AUTH_TOKEN_TYPE_PASSWORD = "sapphire.password";
    public static final String AUTH_TOKEN_TYPE_ACCESS_TOKEN = "sapphire.oauth2.access_token";
    public static final String AUTH_TOKEN_TYPE_REFRESH_TOKEN = "sapphire.oauth2.refresh_token";
    public static final String AUTH_TOKEN_TYPE_SAML_WEB_SSO_SESSION_COOKIE = "sapphire.saml.web_sso.session_cookie";
     ...
     * {@link gi.sapphire.android.authentication.AuthenticatorActivity.KEY_OC_BASE_URL} and
     * {@link gi.sapphire.android.utils.OwnCloudVersion}
     * 
     * @deprecated
     */
